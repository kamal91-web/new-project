...
public class HomeGoogleMapLocation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_google_map_location);
        ...
        if(!isConnected(getApplicationContext())){
            ...
            loadingDialog = new LoadingDialog(HomeGoogleMapLocation.this);
    ...
    private void saveUserAddress() {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, ServerURLs.SAVE_USER_ADDRESS_URL, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("user_mobile",SharedPrefManager.getInstance(HomeGoogleMapLocation.this).getUserMobile());
