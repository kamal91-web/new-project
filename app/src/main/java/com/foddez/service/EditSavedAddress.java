...
public class EditSavedAddress extends AppCompatActivity {
    private Button btnHome, btnOffice, btnOther, btnNext;
    Dialog popupDialig;
    Button closeImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_saved_address);
        ...
        if(!isConnected(getApplicationContext())){
            ...
            myToolbar.setTitle("Set delivery location");
            ...
            loadingDialog = new LoadingDialog(EditSavedAddress.this);
            successDialog=new SuccessDialog(EditSavedAddress.this);
            ...
            txtFlatName.setText(getIntent().getStringExtra("house_number"));
            txtHowToReach= findViewById(R.id.txt_land_mark);
            txtHowToReach.setText(getIntent().getStringExtra("land_mark"));
            txtContactDetal= findViewById(R.id.txt_contact);
            //txtContactDetal.setText(getIntent().getStringExtra("land_mark"));
            String addrest=getIntent().getStringExtra("address_type");
            if(addrest.equals("")){

            }else{
                if(addrest.equals("HOME")){
                    addressType="HOME";
    ...
    private void updateUserAddress() {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, ServerURLs.UPDATE_USER_ADDRESS_URL, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(jObj.getBoolean("error")){
                        ...
                        SharedPrefManager.getInstance(getApplicationContext()).userLogin(jObj.getString("mobileno"),jObj.getString("aid"),jObj.getString("area"),jObj.getString("city"),jObj.getString("address_type"));
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("user_mobile",SharedPrefManager.getInstance(EditSavedAddress.this).getUserMobile());
                params.put("address_id",getIntent().getStringExtra("address_id"));
